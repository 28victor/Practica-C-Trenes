...
void pintaMenu()
{
    char opcions[SORTIR][MAXCADENA] = {"Alta estaciÛ", "Mostrar estaciÛns", "Inserir ruta", "Mostrar rutas", "Mostrar rutes d'una estaciÛ", "Mostrar KM entre dos estaciÛns", "Sortir"};
    printf("\nMEN⁄\n");
